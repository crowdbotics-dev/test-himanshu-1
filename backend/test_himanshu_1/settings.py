"""
Django settings for test_himanshu_1 project.
...
ROOT_URLCONF = 'test_himanshu_1.urls'
...
WSGI_APPLICATION = 'test_himanshu_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_himanshu_1 API",
    "DESCRIPTION": "API documentation for test_himanshu_1 App",
    "VERSION": "v1",
}
